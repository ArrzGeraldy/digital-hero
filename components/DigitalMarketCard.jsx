  ...
  return (
    <div className="gradient-border-wrapper-2" data-aos="fade-up">
      <div className="lg:px-8 lg:py-6 p-4 flex flex-col items-center  h-full   bg-why-gradient  rounded-md">
        ...
        />
        <h4 className="text-base 2xl:text-3xl xl:text-xl text-center text-[#00C6FF] font-bold mt-6">
          {title}
        </h4>
        <p className="2xl:text-2xl xl:text-lg mt-6 2xl:mt-8 text-xs text-slate-200 leading-loose">
          {content}
        </p>
      </div>
    </div>
