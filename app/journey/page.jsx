  ...
  return (
    <main className="h-full relative pb-14 w-10/12 mx-auto">
      ...
      <section className="mt-32">
        <h4 className="text-3xl md:text-4xl xl:text-4xl 2xl:text-6xl font-bold text-center montserrat">
          What Will I
        ...
        <div className="mt-12">
          <div className="bg-why-gradient border-2 mt-6 grid lg:grid-cols-5 gap-8 items-center py-12 2xl:py-16 px-8 border-[#2961CD] rounded-md">
            ...
            <div className="xl:col-span-3 xl:col-start-3">
              <h1 className="text-gradient 2xl:text-6xl xl:text-4xl lg:text-3xl text-3xl font-bold">
                2 Weeks Program
              </h1>
              <p className="font-semibold  2xl:text-2xl xl:text-xl">
      ...
      <section className="mt-32">
        <h4 className="2xl:text-[60px] text-[40px] font-bold text-center ">
          {" "}
        ...
        <p className="mt-12 w-[80%] mx-auto 2xl:text-3xl text-xl font-semibold text-gray-200 text-center">
        ...
        <p className="mt-12 w-[80%] mx-auto 2xl:text-3xl text-xl font-semibold text-gray-200 text-center hidden lg:block">
        ...
        <div className="w-full flex justify-center mt-12">
          <BtnGradient text={"Consult With Out Team"} />
        </div>
      </section>

      <section className="mt-32">
        <h4 className="2xl:text-[50px] text-[40px] font-bold text-center">
      ...
      <section className="mt-32 lg:w-2/3 mx-auto">
        <h4 className="2xl:text-6xl xl:text-5xl text-[40px] font-bold   text-gradient text-center">
        ...
        <div className="px-4 pt-6 pb-16 flex flex-col mt-8  bg-why-gradient border-2 border-[#2961CD] rounded-md">
          <h4 className="2xl:text-[50px] text-[40px] font-bold  text-gradient text-center">
      ...
      <section className="mt-32 lg:w-2/3 mx-auto">
        ...
        <p className="2xl:text-3xl text-xl text-center font-semibold mb-8">
            ...
            <div key={i} className="w-full pb-8 border-b mt-8">
              <div className="flex justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-center lg:text-lg text-sm mt-6">
                    18.30 - 20.30 WIB
                  </p>
                </div>
                <div>
      ...
      <section className="mt-32">
        ...
        <div className="mt-12 lg:grid flex flex-col-reverse grid-cols-2 w-full gap-16 items-center">
          ...
          <div className="2xl:h-full 2xl:flex 2xl:items-start xl:items-center">
