    ...
    <main className="h-full relative  pb-14 ">
        ...
        >
          ...
          <div className="flex  flex-col  items-center absolute px-4 w-full left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            ...
            <div className=" w-[60%] 2xl:mt-10 xl:mt-6  flex gap-8 justify-center font-semibold text-sm lg:text-base">
              ...
              <button className="bg-gradient w-[40%] 2xl:py-6 xl:py-4  rounded-lg 2xl:text-2xl text-xl font-semibold bounce-btn">
                I'm The Winner!
              </button>
            </div>
          </div>
      ...
      <section className="mt-44 w-10/12 mx-auto" data-aos="fade-up">
        ...
        <div className="w-full flex items-center mt-16">
          <button className="bg-gradient mx-auto 2xl:px-12 2xl:py-8 px-6 py-4 2xl:text-3xl text-2xl  font-semibold rounded-lg bounce-btn">
            Start My Journey
          </button>
        </div>
      ...
      <section className="mt-44 w-10/12 mx-auto" data-aos="fade-up">
        <h4 className="2xl:text-6xl xl:text-4xl lg:text-4xl text-3xl font-bold text-center montserrat">
          ...
          <div className="w-full flex items-center">
            <button className="bg-gradient mx-auto 2xl:px-12 2xl:py-8 px-6 py-4 2xl:text-3xl text-2xl  font-semibold rounded-lg mt-12 bounce-btn">
              Let's Collabarate!
            </button>
          </div>
          <div
      ...
      <section className="mt-44 w-10/12 mx-auto" data-aos="fade-up">
        ...
        <div className="mt-12 flex items-center flex-col">
          ...
          <button className="bg-gradient mx-auto w-fit mt-12 font-semibold rounded-lg 2xl:text-3xl 2xl:px-12 2xl:py-8 text-2xl px-8 py-6 bounce-btn">
            Join Our Community
          </button>
        </div>
        <div
          ...
          <div className="bg-why-gradient  flex flex-col justify-start items-start px-4  rounded-md py-12">
            ...
            <div className="w-[95%] flex flex-col-reverse lg:flex-row gap-16 items-center justify-between mt-8 mx-auto">
              <div className="w-3/4  flex flex-col items-center">
                ...
                <p className="mt-4 xl:text-xl 2xl:text-4xl text-lg">
                  We specialize in unlocking the full digital potential for both
                ...
                <button className="bg-gradient mx-auto w-1/2 2xl:py-6 py-4 2xl:text-4xl text-2xl  mt-12 font-semibold rounded-xl bounce-btn">
                  Join Now
                </button>
              </div>
